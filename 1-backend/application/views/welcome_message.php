      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="<?php echo base_url("assets/") ?>/user3-128x128.jpg" alt="User Avatar" class="img-size-50 img-circle mr-3">
              <div class="media-body">
                <h3 class="dropdown-item-title">
                  Nora Silvester
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    <td><?php echo $branches->id; ?></td>
                    <td><?php echo $branches->title; ?></td>
                    <td><?php echo $branches->adress; ?></td>
                    <td><?php echo $branches->created_at; ?></td>
                    <td>SİL - GÜNCELLE</td>
                  </tr>
                  <?php } ?>
                  </tfoot>
